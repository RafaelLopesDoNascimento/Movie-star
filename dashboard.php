...
<div id="main-container" class="container-fluid">
  ...
  <p class="section-description">Adicione ou atualize as informações dos filmes que você compartilhou</p>
      ...
      <tbody>
        <?php foreach ($userMovies as $movie) : ?>
          <tr>
            ...
            <td><a href="<?= $BASE_URL ?>movie.php?id=<?= $movie->id ?>" class="table-movie-title"> <?= $movie->title ?>
              </a></td>
