  ...
  <div class="row">
    ...
    <div class="offset-md-1 col-md-10" id="reviews-container">
        ...
        <div class="col-md-12" id="review-form-container">
          ...
          <form action="<?= $BASE_URL ?>review_process.php" method="post" id="review-form">
            ...
            <div class="form-group">
              ...
              <textarea name="review" id="review" rows="3" class="form-control" placeholder="Oque você achou do filme ?"></textarea>
            </div>
      ...
      <?php if (count($movieReviews) == 0) : ?>
        <p class="empty-list">Não há comentários neste filme ainda</p>
      <?php endif; ?>
      <!-- Comentários -->
    </div>
  </div>
